...
?>
	...
	?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1><small> Pelurusan Info Bangunan </small></h1>
            </div>
        </div>
        ...
        <form class="form-horizontal" method="POST" action="aksi_bangunan.php?act=update">
                ...
                <div class="form-group">
                    <label class="col-md-2">Nama Bangunan</label>
                    <div class="col-md-4">
                        <input type="text" name="nama_bangunan" class="form-control" placeholder="nama bangunan" required>
                    </div>
                </div>
